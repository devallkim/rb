...
if ($uid) {
	...
	$QVAL.= "ptop='".$ptop."',pleft='".$pleft."',width='".$width."',draggable='".$draggable."',type='".$type."',m_type='".$m_type."',dispage='".$dispage."',skin='".$skin."',m_skin='".$m_skin."'";
	...
	$QKEY = "hidden,admin,term0,term1,term2,name,content,m_content,html,m_html,upload,m_upload,position,center,ptop,pleft,width,draggable,type,m_type,dispage,skin,m_skin";
	$QVAL = "'$hidden','$admin','$term0','$term1','$term2','$name','$source','$m_source','$html','$m_html','$upload','$m_upload','$position','$center','$ptop','$pleft','$width','$draggable','$type','$m_type','$dispage','$skin','$m_skin'";
