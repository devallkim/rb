	...
	<div class="page-header">
		<h4>
			...
			<div class="pull-right rb-top-btnbox">
				<?php if($wysiwyg=='Y'):?>
				<div class="btn-group">
					<a class="btn btn-default rb-modal-photoset" href="#." data-toggle="modal" data-target="#modal_window"><i class="fa fa-photo"></i> 포토셋</a>
					<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
						<span class="caret"></span>
					</button>
					<ul class="dropdown-menu pull-right" role="menu">
						<li><a href="#." data-toggle="modal" data-target="#modal_window" class="rb-modal-videoset"><i class="glyphicon glyphicon-facetime-video"></i> 비디오셋</a></li>
						<li><a href="#." data-toggle="modal" data-target="#modal_window" class="rb-modal-widgetedit"><i class="fa fa-puzzle-piece"></i> 위젯</a></li>
					</ul>
				</div>
				<?php else:?>
				<a href="#." class="btn btn-default rb-modal-widgetcode" data-toggle="modal" data-target="#modal_window"><i class="fa fa-puzzle-piece fa-lg"></i> 위젯</a>
				<?php endif?>

				<?php if ($_mtype == 'page'):$_viewpage=RW('mod='.$_HP['id'])?>
				<!-- 페이지 -->
				<div class="btn-group rb-btn-view">
					<a href="<?php echo $_viewpage?>" class="btn btn-default">접속하기</a>
					<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
						<span class="caret"></span>
					</button>
					<ul class="dropdown-menu pull-right" role="menu">
						<li><a href="<?php echo $_viewpage?>" target="_blank"><i class="glyphicon glyphicon-new-window"></i> 새창으로 보기</a></li>
					</ul>
				</div>
				<div class="btn-group">
					<a id="rb-list-back" href="<?php echo $g['s']?>/?r=<?php echo $r?>&amp;m=<?php echo $m?>&amp;module=<?php echo $module?>&amp;front=<?php echo $_mtype?>&amp;uid=<?php echo $uid?>&amp;cat=<?php echo urlencode($cat)?>&amp;p=<?php echo $p?>&amp;recnum=<?php echo $recnum?>&amp;keyw=<?php echo urlencode($keyw)?>" class="btn btn-default"><i class="fa fa-list"></i> 페이지목록</a>
					<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
						<span class="caret"></span>
					</button>
					<ul class="dropdown-menu pull-right" role="menu">
						<?php if($wysiwyg=='Y'):?>
						<li><a href="<?php echo $g['s']?>/?r=<?php echo $r?>&amp;m=<?php echo $m?>&amp;module=<?php echo $module?>&amp;front=_edit&amp;_mtype=<?php echo $_mtype?>&amp;type=source&amp;uid=<?php echo $uid?>&amp;cat=<?php echo urlencode($cat)?>&amp;p=<?php echo $p?>&amp;recnum=<?php echo $recnum?>&amp;keyw=<?php echo urlencode($keyw)?>"><i class="fa fa-code"></i> 소스코드 편집모드</a></li>
						<?php else:?>
						<li><a href="<?php echo $g['s']?>/?r=<?php echo $r?>&amp;m=<?php echo $m?>&amp;module=<?php echo $module?>&amp;front=_edit&amp;_mtype=<?php echo $_mtype?>&amp;type=source&amp;uid=<?php echo $uid?>&amp;cat=<?php echo urlencode($cat)?>&amp;p=<?php echo $p?>&amp;recnum=<?php echo $recnum?>&amp;keyw=<?php echo urlencode($keyw)?>&amp;wysiwyg=Y"><i class="fa fa-edit"></i> 위지위그 편집모드</a></li>
						<?php endif?>
						<li class="divider"></li>
						<li><a href="<?php echo $g['s']?>/?r=<?php echo $r?>&amp;m=<?php echo $m?>&amp;module=<?php echo $module?>&amp;front=<?php echo $_mtype?>"><i class="fa fa-plus"></i> 새 페이지</a></li>
						<li><a href="<?php echo $g['s']?>/?r=<?php echo $r?>&amp;m=<?php echo $module?>&amp;a=deletepage&amp;uid=<?php echo $uid?>&back=Y" onclick="return hrefCheck(this,true,'정말로 삭제하시겠습니까?');"><i class="glyphicon glyphicon-trash"></i> 페이지 삭제</a></li>
					</ul>
				</div>
				...
				<div class="btn-group">
					<a id="rb-list-back" href="<?php echo $g['s']?>/?r=<?php echo $r?>&amp;m=<?php echo $m?>&amp;module=<?php echo $module?>&amp;front=<?php echo $_mtype?>&amp;cat=<?php echo $cat?>&amp;code=<?php echo $code?>" class="btn btn-default"><i class="glyphicon glyphicon-ok"></i> 메뉴목록</a>
					<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
						<span class="caret"></span>
					</button>
					<ul class="dropdown-menu pull-right" role="menu">
						<?php if($wysiwyg=='Y'):?>
						<li><a href="<?php echo $g['s']?>/?r=<?php echo $r?>&amp;m=<?php echo $m?>&amp;module=<?php echo $module?>&amp;front=_edit&amp;_mtype=<?php echo $_mtype?>&amp;type=source&amp;uid=<?php echo $uid?>&amp;cat=<?php echo $cat?>&amp;code=<?php echo $code?>"><i class="fa fa-code"></i> 소스코드 편집모드</a></li>
						<?php else:?>
						<li><a href="<?php echo $g['s']?>/?r=<?php echo $r?>&amp;m=<?php echo $m?>&amp;module=<?php echo $module?>&amp;front=_edit&amp;_mtype=<?php echo $_mtype?>&amp;type=source&amp;uid=<?php echo $uid?>&amp;cat=<?php echo $cat?>&amp;code=<?php echo $code?>&amp;wysiwyg=Y"><i class="fa fa-edit"></i> 위지위그 편집모드</a></li>
						<?php endif?>
						<li class="divider"></li>
						<li><a href="<?php echo $g['s']?>/?r=<?php echo $r?>&amp;m=<?php echo $m?>&amp;module=<?php echo $module?>&amp;front=<?php echo $_mtype?>"><i class="fa fa-plus"></i> 새 메뉴</a></li>
						<li><a href="<?php echo $g['s']?>/?r=<?php echo $r?>&amp;m=<?php echo $module?>&amp;a=deletemenu&amp;cat=<?php echo $cat?>&amp;back=Y" onclick="return hrefCheck(this,true,'정말로 삭제하시겠습니까?');"><i class="glyphicon glyphicon-trash"></i> 메뉴삭제</a></li>
					</ul>
				</div>
				<?php endif?>
			</div>
						...
						<div id="site-code-<?php echo $_key?>" class="panel-collapse collapse<?php if(($_key==$_SESSION['sh_sys_page_edit']) || (!$_SESSION['sh_sys_page_edit']&&$_i==1)):?> in<?php endif?>">
							...
							<div class="rb-codeview">
								<div class="rb-codeview-header">
									...
									<button type="button" class="btn btn-default btn-xs pull-right" data-tooltip="tooltip" title="전체화면" onclick="_nowArea='<?php echo $_key?>';editFullSize('tab-edit-area',this);"><i class="fa fa-arrows-alt fa-lg"></i></button>
								</div>
...
<div id="rb-page-widget">
	...
	<div class="page-header">
		<h4>
			<?php echo $_filetype?> 위젯꾸미기 - <?php echo $_filesbj?>

			<div class="pull-right rb-top-btnbox">
				<a href="#." class="btn btn-default rb-modal-widgetcall" data-toggle="modal" data-target="#modal_window"><i class="fa fa-puzzle-piece fa-lg"></i> 위젯 불러오기</a>
				<?php if ($_mtype == 'page'):$_viewpage=RW('mod='.$_HP['id'])?>
				<!-- 페이지 -->
				<div class="btn-group rb-btn-view">
					<a href="<?php echo $_viewpage?>" class="btn btn-default">접속하기</a>
				...
				<!-- 메뉴 -->
				<div class="btn-group">
					<a href="<?php echo $_viewpage?>" class="btn btn-default">문서보기</a>
					<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
						<span class="caret"></span>
					</button>
					<ul class="dropdown-menu pull-right" role="menu">
	...
	<div class="form-group">
		<button class="btn btn-primary btn-block btn-lg" id="rb-submit-button" type="button" onclick="widgetcheck();"><i class="fa fa-check fa-lg"></i> 적용하기</button>
	</div>
</div>
...
function makeWorkspace()
{
    ...
    for (i=0; i<maxTiles; i++)
	{
		...
		' <div><img src="<?php echo $g['s']?>/modules/site/pages/images/btn_move.gif" style="position:relative;top:-2px;" title="이동" data-tooltip="tooltip"> <span id="wtitle'+i+'" style="position:relative;top:-1px;">'+blocktitle[i]+'</span></div>'+
		' <div style="text-align:right;position:relative;top:-20px;">'+
		' <img src="<?php echo $g['s']?>/modules/site/pages/images/btn_conf.gif" alt="" title="속성" onmousedown="getWidget('+i+');" style="cursor:pointer;" data-tooltip="tooltip" class="rb-modal-widgetcall-modify"  data-toggle="modal" data-target="#modal_window">'+
		' <img src="<?php echo $g['s']?>/modules/site/pages/images/btn_del.gif" alt="" title="삭제" onclick="delWidget('+i+');" style="cursor:pointer;"data-tooltip="tooltip">'+
		' </div>'+
