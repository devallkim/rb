...
<div id="pages_idpw">
	...
	<ul class="nav nav-tabs">
		<li class="nav-item"><a href="#idpwsearch-1" data-toggle="tab" class="nav-link active"><i class="fa fa-search fa-lg"></i> <?php echo $d['member']['login_emailid']?'이메일':'아이디'?> 찾기</a></li>
		<li class="nav-item"><a href="#idpwsearch-2" data-toggle="tab" class="nav-link"><i class="fa fa-key fa-lg"></i> 임시비밀번호 요청</a></li>
	</ul>
					...
					<form name="procForm1" class="form-horizontal" action="<?php echo $g['s']?>/" method="post" target="_action_frame_<?php echo $m?>" onsubmit="return idCheck(this);">
						...
						<div class="form-group row">
							<div class="offset-sm-2 col-sm-9">
							   ...
							   <a href="#modal-login" data-toggle="modal" class="btn btn-secondary">로그인 하기</a>
							</div>
						</div>
					</form>
				</div>
			</div>
			<p class="text-left text-muted small card card-block">
