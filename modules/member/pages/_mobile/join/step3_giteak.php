			...
			<div class="">
			    ...
			    <div class="">
						...
						<div class="form-group row">
							...
							<div class="col-8">
								<div class="input-group">
						      <input type="email" class="form-control" name="email" id="email" placeholder="비밀번호 잊어버렸을 때 확인 받을 수 있습니다." onblur="sameCheck(this,'hLayeremail');">
						      <span class="input-group-btn">
						        <button class="btn btn-secondary" type="button" id="rb-emailcheck" disabled><span id="hLayeremail">유효성 결과</span></button>
						      </span>
						    </div><!-- /.input-group -->
				      ...
				      <div class="col-8 offset-3">
						...
						<div class="form-group row">
							<label for="id" class="col-3 col-form-label rb-form-required">
								<?php if($d['member']['form_tel2_p']):?><span class="text-danger">*</span><?php endif?>
									휴대폰
								</label>
							<div class="col-9">
								<div class="form-inline">
								    ...
								    <label class="sr-only" for="">국번</label>
										<select class="form-control custom-select mr-2" iid="tel2_1" name="tel2_1">
								      <option>010</option>
								      <option>011</option>
								      <option>016</option>
								    </select>
								    ...
								    <input type="number" class="form-control mr-2" id="tel2_2" name="tel2_2" placeholder="" style="width: 90px" maxlength="4">

										<label class="sr-only" for="">뒷자리</label>
										<input type="number" class="form-control mr-2" id="tel2_3" name="tel2_3" placeholder="" style="width: 90px" maxlength="4">
						...
						<div class="form-group row">
							...
							<div class="col-8">
								<div class="input-group">
									...
									<span class="input-group-btn">
										<button class="btn btn-secondary" type="button" id="rb-idcheck" disabled><span id="hLayernic">유효성 결과</span></button>
									</span>
								</div><!-- /.input-group -->
							</div>
						</div><!-- /.form-group -->
						...
						<div class="form-group row">
							<label for="pw2" class="col-3 col-form-label rb-form-required">
							<?php if($d['member']['form_sex_p']):?><span class="text-danger">*</span><?php endif?>
								성별
							</label>
							<div class="col-8">
								<div class="form-inline">
						...
						<div class="form-group row">
							<label for="id" class="col-3 col-form-label rb-form-required">
								<?php if($d['member']['form_birth_p']):?><span class="text-danger">*</span><?php endif?>
									생년월일
								</label>
							<div class="col-9">
								<div class="form-inline">
              ...
              <?php endif?>
                 <hr>
						<div class="mt-2 text-center">
							<button type="button" class="btn btn-secondary" onclick="goHref('/');">가입취소</button>
