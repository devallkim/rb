...
fwrite($fp, "\$d['member']['form_bio'] = \"".$form_bio."\";\n");
...
fwrite($fp, "\$d['member']['form_bio_required'] = \"".$form_bio_required."\";\n");
fwrite($fp, "\$d['member']['form_home_required'] = \"".$form_home_required."\";\n");
fwrite($fp, "\$d['member']['form_tel1_required'] = \"".$form_tel1_required."\";\n");
fwrite($fp, "\$d['member']['form_tel2_required'] = \"".$form_tel2_required."\";\n");
fwrite($fp, "\$d['member']['form_job_required'] = \"".$form_job_required."\";\n");
fwrite($fp, "\$d['member']['form_marr_required'] = \"".$form_marr_required."\";\n");
fwrite($fp, "\$d['member']['form_addr_required'] = \"".$form_addr_required."\";\n");
fwrite($fp, "\$d['member']['form_nic'] = \"".$form_nic."\";\n");
fwrite($fp, "\$d['member']['form_nic_required'] = \"".$form_nic_required."\";\n");
fwrite($fp, "\$d['member']['form_birth'] = \"".$form_birth."\";\n");
fwrite($fp, "\$d['member']['form_birth_required'] = \"".$form_birth_required."\";\n");
fwrite($fp, "\$d['member']['form_sex'] = \"".$form_sex."\";\n");
fwrite($fp, "\$d['member']['form_sex_required'] = \"".$form_sex_required."\";\n");
