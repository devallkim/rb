	...
	<div class="row">
		<div class="col-sm-3 col-md-3 col-xl-3 d-none d-sm-block sidebar">
			...
			<div class="card">
		      ...
		      <a class="list-group-item list-group-item-action active" data-toggle="list" href="#signup-config" role="tab" id="join_1">
						<i class="fa fa-cog fa-lg pull-right"></i> 회원가입 설정
					</a>
		      <a class="list-group-item list-group-item-action" data-toggle="list" href="#signup-form-config" role="tab" id="join_2">
						<i class="fa fa-file-text-o fa-lg pull-right"></i> 가입양식 관리
					</a>
		      <a class="list-group-item list-group-item-action" data-toggle="list" href="#signup-form-add" role="tab" id="join_3">
						<i class="fa fa-plus-circle fa-lg pull-right"></i> 가입항목 추가
					</a>
		      <a class="list-group-item list-group-item-action" data-toggle="list" href="#profile" role="tab" id="join_4">
						<i class="fa fa-sign-in fa-lg pull-right"></i> 개인정보 설정
					</a>
					<a class="list-group-item list-group-item-action" data-toggle="list" href="#terms" role="tab" id="join_5">
		...
		<div class="col-sm-9 col-md-9 ml-sm-auto col-xl-9 pt-3">
				...
				<div class="tab-content" id="setting-content">
					 <div class="tab-pane fade show active" id="signup-config">
						<!-- 회원가입 설정 -->
							<h3>회원가입 설정</h3>
							<div class="row">
								<div class="col-sm-6">
									...
									<div class="form-group">
										...
										<div>
											...
											<label class="custom-control custom-radio">
											  <input type="radio" class="custom-control-input"  name="join_out" value="1" <?php if($d['member']['join_out']==1):?>checked<?php endif?>>
											  <span class="custom-control-indicator"></span>
											  <span class="custom-control-description">즉시삭제</span>
											</label>
											<label class="custom-control custom-radio">
											  <input type="radio" class="custom-control-input" name="join_out" value="2" <?php if($d['member']['join_out']==2):?>checked<?php endif?>>
											  <span class="custom-control-indicator"></span>
											  <span class="custom-control-description">관리자 확인 후 삭제</span>
											</label>
								...
								<div class="col-sm-6">
									<div class="form-group error">
										...
										<div>
											...
											<label class="custom-control custom-radio">
											  <input type="radio" class="custom-control-input" name="join_rejoin" value="1" <?php if($d['member']['join_rejoin']):?>checked<?php endif?> id="inlineCheckbox1">
											  <span class="custom-control-indicator"></span>
											  <span class="custom-control-description">허용함</span>
											</label>
											<label class="custom-control custom-radio">
											  <input type="radio" class="custom-control-input" name="join_rejoin" value="0" <?php if(!$d['member']['join_rejoin']):?>checked<?php endif?> id="inlineCheckbox2">
											  <span class="custom-control-indicator"></span>
											  <span class="custom-control-description">허용 안함</span>
											</label>
									...
									<div class="form-group">
										...
										<div>
											...
											<label class="custom-control custom-checkbox">
											  <input type="checkbox" class="custom-control-input" name="join_email_send" value="1"<?php if($d['member']['join_email_send']):?> checked="checked"<?php endif?>>
											  <span class="custom-control-indicator"></span>
											  <span class="custom-control-description">가입안내 이메일 발송</span>
											</label>
					...
					<!-- /회원가입 설정 -->
					 ...
					 <!-- 가입양식 관리 -->
					<div class="tab-pane fade" id="signup-form-config">
						<h3>가입양식 관리</h3>
							<div class="row">
								<div class="col-sm-6">
									<div class="form-group">
							...
							<div class="row">
								...
								<div class="col-sm-6">
									<div class="form-group">
										...
										<div class="col-sm-8">
											<div class="btn-group" data-toggle="buttons">
												<label class="btn btn-light <?php if(!$d['member']['form_comp']):?>active<?php endif?>">
					 ...
					 <!-- 가입항목 추가 -->
					 <div class="tab-pane fade" id="signup-form-add">
						 <h3>가입항목 추가</h3>
						 <div class="mb-4">
						...
						<h3>개인정보 설정</h3>
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
									...
									<div class="checkbox">
										<label><input type="checkbox" name="use_login_cookie" value="1" <?php if($d['member']['use_login_cookie']):?> checked="checked"<?php endif?>/> 로그인 유지 기능 사용</label>
									</div>
								</div>
							</div>

							<div class="form-group">
							 <label for="mytab_recnum" class="col-sm-2 control-label">로그인 유지기간</label>
							 <div class="col-sm-2">
								 <div class="input-group">
						...
						<h3>약관/안내 메시지</h3>
							<div class="panel-group" id="accordion">
								<div class="panel panel-default">
									...
									<div class="panel-collapse collapse show" id="terms-1">
										<div>
