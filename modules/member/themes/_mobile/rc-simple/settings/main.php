...
<div id="page-main" class="page center">
	...
	<main class="content bg-faded">
		...
		<ul class="table-view bg-white m-t-0 animated fadeIn delay-1">
			...
			<li class="table-view-cell">
				<?php echo $my['id'] ?>
				<button class="btn btn-secondary js-btn-action-iframe" data-href="<?php echo $g['s']?>/?r=<?php echo $r?>&a=logout&referer=<?php  echo RW(0) ?>">로그아웃</button>
			</li>
			<li class="table-view-cell">
			...
			<li class="table-view-divider">옵션</li>
			<?php if($d['member']['form_settings_tel2']):?>
		  <li class="table-view-cell" style="padding-right: 6rem ">
				<div class="media-body">
		    	알림문자 수신
					<p>각종 이벤트,알림 SMS를 수신합니다.</p>
				</div>
				<div data-toggle="switch" class="switch<?php echo $my['sms']==1?' active':'' ?>" id="reception_sms">
			...
			<li class="table-view-cell" style="padding-right: 6rem ">
				<div class="media-body">
		    	공지메일 수신
					<p>뉴스레터나 공지 이메일을 수신합니다.</p>
				</div>
				<div data-toggle="switch" class="switch<?php echo $my['mailing']==1?' active':'' ?>" id="reception_email">
					<div class="switch-handle"></div>
				</div>
		  </li>
