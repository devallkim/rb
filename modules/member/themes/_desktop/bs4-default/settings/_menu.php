<div class="card mb-3">
  ...
  <div class="list-group list-group-flush">
    ...
    <a href="<?php echo $g['url_reset']?>&amp;page=connect" class="list-group-item list-group-item-action<?php if($page=='connect'):?> selected<?php endif?>">
      연결계정 관리
    </a>
    <?php endif; ?>
    <a href="<?php echo $g['url_reset']?>&amp;page=email" class="list-group-item list-group-item-action<?php if($page=='email'):?> selected<?php endif?>">
      이메일 관리
    </a>
    <a href="<?php echo $g['url_reset']?>&amp;page=phone" class="list-group-item list-group-item-action<?php if($page=='phone'):?> selected<?php endif?>">
      휴대폰 관리
    </a>
    <a href="<?php echo $g['url_reset']?>&amp;page=shipping" class="list-group-item list-group-item-action<?php if($page=='shipping'):?> selected<?php endif?>">
      배송지 관리
    </a>
