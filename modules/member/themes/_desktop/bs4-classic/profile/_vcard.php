...
<ul class="vcard-details border-top border-gray-light mt-3 pt-2 list-unstyled">
  ...
  <li aria-label="Home location" class="vcard-detail pt-1 text-truncate">
    <i class="fa fa-map-marker fa-lg fa-fw" aria-hidden="true"></i> <?php if($_MP['addr0']):?> <?php echo $_MP['addr0']?><?php endif?>
  </li>
  <?php endif; ?>
  ...
  <li aria-label="Email" class="vcard-detail pt-1 text-truncate">
    ...
    <a href="mailto:<?php echo $_MP['email'] ?>" class="muted-link"><?php echo $_MP['email'] ?></a>
    <?php else: ?>
  ...
  <li aria-label="Blog or website" class="vcard-detail pt-1 text-truncate">
    ...
    <a href="http://<?php echo $_MP['home'] ?>" target="_blank" class="muted-link"><?php echo $_MP['home'] ?></a>
  </li>
  <?php endif; ?>
  <?php if ($_MP['company']): ?>
  <li aria-label="Blog or website" class="vcard-detail pt-1 text-truncate">
