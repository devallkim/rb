...
if($type == 'follower')
{
	$bbsque	= 'by_mbruid='.$_MH['uid'];
	$_fmemberuid = 'my_mbruid';
}
if($type == 'following')
{
	$bbsque	= 'my_mbruid='.$_MH['uid'];
	$_fmemberuid = 'by_mbruid';
}
if($type == 'friend')
{
	$bbsque	= 'by_mbruid='.$_MH['uid'].' and rel=1';
	$_fmemberuid = 'my_mbruid';
}
	...
	<div class="page-wrapper row">
		...
		<div class="col-9 page-main">
			...
			<?php if(!db_num_rows($RCD)):?>
				...
				<div class="blankslate blankslate-spacious blankslate-large wiki mt-4">
				  <i class="fa fa-user-plus fa-2x text-gray-light" aria-hidden="true"></i>
				  <h3 class="mt-2">아직 팔로워가 없습니다.</h3>
