...
$sqlque1 = 'mbruid='.$my['uid'].' and prim=1 and backup=0';
$sqlque2 = 'mbruid='.$my['uid'].' and prim=0';
$sqlque3 = 'mbruid='.$my['uid'].' and backup=0 and d_verified<>0';
$sqlque4 = 'mbruid='.$my['uid'].' and prim=0 and d_verified<>0';
      ...
      <?php while($P=db_fetch_array($PCD)):?>
        <li class="list-group-item d-flex justify-content-between align-items-center">
          <div>
            ...
            <?php if ($P['prim']): ?><span class="badge badge-primary">기본</span><?php endif; ?>
          </div>
          <button type="button" class="btn btn-link muted-link py-0" data-act="del" data-toggle="tooltip" title="삭제" data-uid="<?php echo $P['uid'] ?>">
      ...
      <div class="mt-4">
        ...
        <div class="form-inline" id="save-primary">
          <select class="form-control custom-select">
            ...
            <option value="<?php echo $V['uid'] ?>"<?php echo $V['prim']?' selected':'' ?>>
