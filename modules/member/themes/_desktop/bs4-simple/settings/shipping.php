            ...
            <form id="shippingForm" role="form" action="<?php echo $g['s']?>/" method="post" >
              ...
              <input type="hidden" name="uid" value="">
                ...
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">배송지명</label>
                  <div class="col-sm-10">
                    <input type="text" name="label" class="form-control w-50" placeholder="">
                  </div>
                </div>
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">수령인 <span class="text-danger">*</span></label>
                  <div class="col-sm-10">
                ...
                <div class="form-group row">
                  <label class="col-sm-2 col-form-label">연락처2</label>
                  <div class="col-sm-10">
                    <div class="form-inline">
...
$(function () {
  ...
  modal.on('shown.bs.modal', function () {
    modal.find('[name="label"]').trigger('focus')
  })
