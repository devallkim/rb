		...
		<div class="col-9 page-main">
			...
			<div class="subnav clearfix my-3">
				<div class="subnav-links">
					<a class="subnav-item selected" onclick="catFlag('');">팔로워 <small>694</small></a>
					<a class="subnav-item" onclick="catFlag('1');">팔로잉 <small>508</small></a>
					<a class="subnav-item" onclick="catFlag('2');">친구 <small>186</small></a>
				</div>
			</div>
