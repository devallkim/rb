			...
			<div class="panel-group" id="accordion">
				<div class="card py-0">
					<div class="card-header d-flex justify-content-between py-2 align-items-center">
						...
						<button type="button" class="btn btn-link muted-link<?php if(!$_SESSION['sh_site_page_search']):?> collapsed<?php endif?>" data-toggle="collapse" data-target="#panel-search" data-tooltip="tooltip" title="검색필터" onclick="sessionSetting('sh_module_search','1','','1');getSearchFocus();">
					...
					<div class="panel-collapse collapse show" id="collapmetane" style="height: calc(100vh - 9rem);">
				...
				<div class="card">
					<div class="card-header">
						<a class="accordion-toggle collapsed d-block muted-link" data-parent="#accordion" data-toggle="collapse" href="#collapseTwo">
				...
				<div class="col-lg-10 col-xl-9">
					...
					<p class="form-control-static">
						<ul class="list-unstyled text-muted mb-0">
							...
							<li><small>아이콘 폰트 제작 방법은 <a href="http://docs.kimsq.com/" target="_blank">도움말</a>을 참고해 주세요.</small></li>
