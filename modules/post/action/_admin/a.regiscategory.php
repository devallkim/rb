...
if ($cat && !$vtype)
{
	...
	$QVAL = "metaurl='$metaurl',metause='$metause',id='$id',name='$name',mobile='$mobile',hidden='$hidden',vtype='$vtype1',recnum='$recnum',vopen='$vopen',linkedmenu='$linkedmenu'";
	...
	if ($depth > 3) getLink('','','카테고리는 최대 4단계까지 등록할 수 있습니다.','');
