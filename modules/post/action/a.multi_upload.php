...
if(isset($_FILES["files"]))
{
   if ($fserver)
    ...
    $QKEY = "gid,pid,hidden,tmpcode,parent,mbruid,fileonly,type,ext,fserver,url,folder,name,tmpname,thumbname,size,width,height,caption,down,d_regis,d_update";
    $QVAL = "'$gid','$gid','$hidden','$tmpcode','','$mbruid','1','$type','$fileExt','$fserver','$url','$folder','$name','$tmpname','$thumbname','$size','$width','$height','$caption','$down','$d_regis','$d_update'";
    ...
    $html=getUploadFileList($R); // tree.func.php 파일 해당 함수 참조 
    echo $html; 
}  
exit;
?>
