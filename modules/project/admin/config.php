		...
		<div class="card-body">
			...
			<form name="procKey" action="<?php echo $g['s']?>/" method="post" onsubmit="return saveCheck(this);">
				...
				<div class="input-group input-group-lg">
					...
					<input class="form-control" type="text" name="key" value="<?php echo trim(implode('',file($g['path_var'].'project.key.txt')))?>" required  autocomplete="off">
					<div class="input-group-append">
						<button class="btn btn-light" type="submit">저장</button>
					</div>
				</div>
				<small class="form-text text-muted mt-2">
					라이브 설치 시 자동으로 입력됩니다. 프로젝트의 제반정보의 연동을 위한 인증 및 지원을 위해 활용됩니다.<br>
