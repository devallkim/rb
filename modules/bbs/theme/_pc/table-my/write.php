...
$(document).ready(function() {
      ...
      $('#summernote').summernote({
       ...
       //[groupname, [button list]]  : 툴바 그룹 [버튼 id ]  참조 페이지 ==> http://summernote.org/#/features  : 아래 순서대로 노출된다.
         ['style', ['style']],
         ['fontstyle', ['bold','strikethrough','italic','underline', 'clear']],
         ['fontsize', ['fontsize']],
         ['color', ['color']],
         ['height', ['height']],
   ...
   <form name="writeForm" method="post" action="<?php echo $g['s']?>/" onsubmit="return writeCheck(this);" class="form-horizontal" enctype="multipart/form-data">
    ...
    <input type="hidden" name="featured_img" value="<?php echo $R['featured_img']?>" />
      ...
      <?php if(!$my['uid']):?>
        <div class="form-group row">
           <label for="user_name" class="col-1 col-form-label text-right">이름</label>
           <div class="col-11">
         ...
         <div class="form-group row">
            <label for="password" class="col-1 col-form-label text-right">암호</label>
            <div class="col-11">
    ...
    <?php if($B['category']):$_catexp = explode(',',$B['category']);$_catnum=count($_catexp)?>
       <div class="form-group rb-category">
           <label for="" class="col-1 col-form-label text-right">분류</label>
           <div class="col-11">
      ...
      <?php endif?>
       ...
       <div class="form-group row hidden">
           <label for="tag" class="col-1 col-form-label text-right">태그</label>
           <div class="col-11">
       ...
       <div class="form-group row">
           <label for="snsconnect" class="col-1 col-form-label text-right">SNS</label>
           <div class="col-11">
...
<?php getImport('summernote','dist/summernote.min','0.5.9','js')?>
<?php getImport('summernote','lang/summernote-ko-KR','0.5.9','js')?>
<?php getImport('summernote','dist/summernote','0.5.9','css')?>
