 <div class="bbs-header clearfix mt-3">
    <h2 class="float-left"><i class="fa fa-circle-o text-primary" aria-hidden="true"></i> 메일로 문의하기</h2>
    <?php if($Ltype=='list'):?>
    <form class="float-right mr-1" name="bbssearchf" action="<?php echo $g['s']?>">
