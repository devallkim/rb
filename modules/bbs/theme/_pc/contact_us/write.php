...
// 폼전송 후 리턴 페이지 세팅
$success_url = $now_url.'?type=success';
...
<!-- 템플릿 시작 -->
<section>
      <h1><i class="fa fa-circle-o text-primary" aria-hidden="true"></i> 메일로 문의하기</h1>
    ...
    <form name="writeForm" method="post" action="<?php echo $g['s']?>/" enctype="multipart/form-data" onsubmit="return writeCheck(this);">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                ...
                <td><input type="text" class="form-control" name="name" placeholder="" style="width: 315px"></td>
              </tr>
              <tr>
                <th scope="row">이메일</th>
                <td><input type="email" class="form-control" name="email" placeholder="" style="width: 315px"></td>
              </tr>
              <tr>
                <th scope="row">연락처</th>
                <td><input type="text" class="form-control"  name="tel" style="width: 315px"></td>
              </tr>
              <tr>
                <th scope="row">제목</th>
              ...
              <tr>
                ...
                <td>
                    ...
                    <small class="float-right mt-2 pr-1">글자수  <strong class="text-danger" id="nowLength-wrap">0</strong> / 200</small>
                </td>
              </tr>
              <tr>
                ...
                <td>
                  <div class="input-group" >
                    <span class="input-group-btn">
                        ...
                        <button class="btn btn-secondary" type="button" data-role="open-file">파일선택</button>
                    </span>
        ...
        <p class="text-center">
            <button type="submit" name="button" class="btn btn-primary" role="button">보내기</button>
        </p>
    </form>
    <?php endif?>
