   ...
   <form name="writeForm" method="post" action="<?php echo $g['s']?>/" onsubmit="return writeCheck(this);" class="form-horizontal" enctype="multipart/form-data">
    ...
    <input type="hidden" name="featured_img" value="<?php echo $R['featured_img']?>" />
      ...
      <?php if(!$my['uid']):?>
        <div class="form-group row">
           <label for="user_name" class="col-1 col-form-label text-right pr-0">이름</label>
           <div class="col-11">
         ...
         <div class="form-group row">
            <label for="password" class="col-1 col-form-label text-right pr-0">암호</label>
            <div class="col-11">
    ...
    <?php if($B['category']):$_catexp = explode(',',$B['category']);$_catnum=count($_catexp)?>
       <div class="form-group rb-category">
           <label for="" class="col-1 col-form-label text-right pr-0">분류</label>
           <div class="col-11">
      ...
      <?php endif?>
       <div class="form-group row">
           <label for="subject" class="col-1 col-form-label text-right pr-0">제목</label>
           <div class="col-11">
