...
//content 에 이름 & 메일 포함 추가
$adddata_arr = explode('^^',$adddata);
$content2 = '문의자 : '.$name.'<br/>';
//$content2.= '메일 : '.$adddata_arr[1].'<br/><br/>';
$content2.= '메일 : '.$email.'<br/><br/>';
$content2.=  nl2br($content);
foreach ($to_email_arr as $to_email) {
    SendSMTP($to_email,$to_name,$from_name,$from_email,$title,$content2);
}
