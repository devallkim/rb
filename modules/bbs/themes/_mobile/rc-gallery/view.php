	...
	<main class="content">
		<div class="mb-3" data-role="post">
			...
			<div class="content-padded text-xs-center my-4" >
				...
				<button type="button" class="btn btn-secondary<?php if($is_liked):?> active<?php endif?>"
					data-act="opinion"
				...
				<button type="button" class="btn btn btn-secondary<?php if($is_disliked):?> active<?php endif?>"
					data-act="opinion"
        ...
        <h6><i class="fa fa-tag" aria-hidden="true"></i> 태그</h6>
      ...
      <?php endif?>
		    ...
		    */
		    ...
		    <div class="mt-2 content-padded" id="anchor-comments">
		      <?php getWidget('_default/comment-rc',array('module'=>'bbs','parent_uid' => $R['uid'],'parent_table'=>'rb_bbs_data','theme' => '_mobile/rc-default'))?>
		    </div>
