...
<section id="page-bbs-list" data-role="bbs-list">
  ...
  <div class="bar bar-standard bar-header-secondary bg-white px-0">
    <nav class="nav nav-inline">
      <a class="nav-link<?php echo !$type?' active':'' ?>" href="<?php echo $g['bbs_reset'] ?>" data-control="push">
        전체글
        <span class="badge badge-primary badge-outline"><?php echo $NUM ?></span>
      </a>

      <?php if ($NUM_NOTICE): ?>
      <a class="nav-link<?php echo $type=="notice"?' active':'' ?>" href="<?php echo $g['bbs_reset'] ?>&type=notice" data-control="push">
        공지
        <span class="badge badge-primary badge-outline"><?php echo $NUM_NOTICE ?></span>
      </a>
      <?php endif; ?>
