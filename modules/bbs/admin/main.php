...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-sm-4 col-md-4 col-xl-3 d-none d-sm-block sidebar">
			...
			<a href="<?php echo $g['adm_href']?>" class="btn btn-link btn-block">검색조건 초기화</a>
		...
		<div class="col-sm-8 col-md-8 ml-sm-auto col-xl-9 pt-3">
			...
			<!-- 리스트 시작  -->
			<div class="mb-2">
				<small><?php echo $num?>개 ( <?php echo $p?>/<?php echo $TPG.($TPG>1?' pages':' page')?> )</small>
			</div>
			<form name="listForm" action="<?php echo $g['s']?>/" method="post">
						...
						<table class="table table-striped">
							...
							<tr>
								...
								<td>
									...
									<a href="<?php echo $g['adm_href']?>&amp;front=main_detail&amp;uid=<?php echo $R['uid']?>">설정</a>
								</td>
					   	</tr>
							<?php endwhile?>
						</table>
					...
					<div class="rb-footer clearfix">
						...
						<div>
							<button type="button" onclick="chkFlag('bbs_members[]');checkboxCheck();" class="btn btn-light btn-sm">선택/해제</button>
							<button type="button" onclick="actCheck('multi_config');" class="btn btn-light btn-sm" id="rb-action-btn">수정</button>
						</div>
					</div> <!-- .rb-footer -->
			</form>
