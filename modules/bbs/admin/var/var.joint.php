...
<div id="mjointbox">
	<div class="title">
		<form name="bbsSform" class="form-horizontal rb-form" action="<?php echo $g['s']?>/" method="get">
      ...
      <div class="input-group">
          ...
          <input type="text" name="_keyw" size="15" value="<?php echo addslashes($_keyw)?>" class="form-control" />
		    <span class="input-group-btn">
		        ...
		        <input type="button" value=" 리셋 " class="btn btn-default" onclick="thisReset();" />	
           </span>
	...
	<table class="table">
		...
		<tr>
				...
				<td class="nopd-right">
					<input type="button" value="C" title="게시판관리" class="btn btn-default btn-sm" onclick="window.open('<?php echo $g['s']?>/?r=<?php echo $r?>&m=admin&module=<?php echo $smodule?>&front=main');" />
					<input type="button" value="T" title="테마설정" class="btn btn-default btn-sm" onclick="window.open('<?php echo $g['s']?>/?r=<?php echo $r?>&m=admin&module=<?php echo $smodule?>&front=skin&theme=<?php echo $d['bbs']['skin_total']?>');" />		
					<button class="pull-right btn btn-default btn-sm" onclick="dropJoint('<?php echo $g['s']?>/?r=<?php echo $r?>&m=<?php echo $smodule?>');" /><i class="glyphicon glyphicon-save"></i> 연결하기</button>
				</td>
		</tr>
		...
		<td>
			<?php if($R['category']):?>
			<select id="cat<?php echo $R['id']?>" class="form-control input-sm" title="<?php echo $R['id']?>">
		...
		<td class="nopd-right">
			<input type="button" value="C" title="게시판설정" class="btn btn-default btn-sm" onclick="window.open('<?php echo $g['s']?>/?r=<?php echo $r?>&m=admin&module=<?php echo $smodule?>&front=main&uid=<?php echo $R['uid']?>');" />
			<input type="button" value="T" title="테마설정" class="btn btn-default btn-sm" onclick="window.open('<?php echo $g['s']?>/?r=<?php echo $r?>&m=admin&module=<?php echo $smodule?>&front=skin&theme=<?php echo $d['bbs']['skin']?$d['bbs']['skin']:$d['bbs']['skin_main']?>');" />
			<button class="pull-right btn btn-default btn-sm" onclick="dropJoint('<?php echo $g['s']?>/?r=<?php echo $r?>&m=<?php echo $smodule?>&bid=<?php echo $R['id']?>'+(getId('cat<?php echo $R['id']?>').value?'&cat='+getId('cat<?php echo $R['id']?>').value:''));" /><i class="glyphicon glyphicon-save"></i> 연결하기</button>
		</td>
		</tr>
		<?php endwhile?>
	</table>
...
.table td.nopd-right {padding-right: 0}
