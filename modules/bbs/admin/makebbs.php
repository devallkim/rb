			   ...
			   <div class="card">
			     ...
			     <div id="collapseOne" class="collapse show" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion">
						 ...
						 <div class="list-group list-group-flush" style="height: calc(100vh - 16.6rem);">
							 ...
							 <a href="<?php echo $g['adm_href']?>&amp;recnum=<?php echo $recnum?>&amp;p=<?php echo $p?>&amp;uid=<?php echo $BR['uid']?>" class="list-group-item list-group-item-action justify-content-between align-items-center">
								 <?php echo $BR['name']?>(<?php echo $BR['id']?>)
								 <span class="badge badge-primary badge-pill ml-auto"><?php echo number_format($BR['num_r'])?></span>
							 </a>
							 <?php $_i++;endwhile?>
							 <?php else:?>
						 ...
						 <div class="card-footer">
						 	 <a href="<?php echo $g['adm_href']?>&amp;front=makebbs"  class="btn btn-outline-primary btn-block"><i class="fa fa-plus"></i> 새 게시판 만들기</a>
						 </div>
	   		...
	   		<!-- 메뉴 패널 헤더 : 아이콘 & 제목 -->
				<div class="card-header">
					...
					<span class="pull-right">
						<button type="button" class="btn btn-default btn-xs<?php if(!$_SESSION['sh_site_bbs_search']):?> collapsed<?php endif?>" data-toggle="collapse" data-target="#panel-search" data-tooltip="tooltip" title="검색필터" onclick="sessionSetting('sh_site_bbs_search','1','','1');getSearchFocus();">
				...
				<div class="card-footer">
					<a href="<?php echo $g['adm_href']?>&amp;front=makebbs" class="btn btn-outline-primary btn-block">
