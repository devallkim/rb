	...
	$html.='
	 ...
	 if($R['type']==2){
	      $html.='
            ...
            <div class="media ml-5 mr-auto align-items-center w-75">
                <img class="d-flex align-self-center mr-3 border" src="'.$thumb_list.'" alt="'.$caption.'" style="width: 50px">
      ...
      $html.='<div class="align-self-center"><div class="btn-group btn-group-sm">';
						$html.='
						<button type="button" class="btn btn-light" data-attach-act="delete" data-id="'.$R['uid'].'" data-role="attachList-menu-delete-'.$R['uid'].'" data-featured="" data-type="'.$type.'">삭제</button>
						<button type="button" class="btn btn-light" data-attach-act="insert" data-type="'.$type.'" data-origin="'.($R['type']==2?$img_origin:$src).'" data-caption="'.$caption.'" data-id="'.$R['uid'].'" data-role="attachList-menu-insert-'.$R['uid'].'" data-editor="'.$editor.'">본문삽입</button>';
						if($mod=='upload'){
						$html.='
                     ...
                     <div class="meta"><span class="badge badge-pill badge-danger">Youtube</span> <span class="badge badge-pill badge-secondary" data-role="attachList-list-time-'.$R['uid'].'">'.$R['time'].'</span></div>
						...
						<span class="ml-auto">
							<div class="btn-group btn-group-sm">';
									...
									$html.='
									<div class="btn-group"><button type="button" class="btn btn-light dropdown-toggle" data-toggle="dropdown" role="button">
									</button>
