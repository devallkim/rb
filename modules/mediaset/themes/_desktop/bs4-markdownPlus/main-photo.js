 ...
 */
(function ($) {
    $.fn.RbAttachPhoto= function (settings) {
        ...
        $(container).on('click','[data-attach-act]',function(e){
              ...
              if(act=='delete'){
                   ...
                   $.post(rooturl+'/?r='+raccount+'&m='+module+'&a=edit',{
              ...
              }else if(act=='save-photo'){ // 정보수정 저장
                    ...
                    var filesrc=$(modal).find('[data-role="img-preview"]').attr('src'); // 원본 이미지 소스
