...
<header class="navbar navbar-expand fixed-top navbar-dark bg-dark" role="navigation">
		...
		<div class="navbar-collapse collapse">
			...
			<ul class="navbar-nav mr-auto" id="rb-admin-ul-tabs">
				...
				<?php $front_split = explode('_',$front); ?>

				<li id="rb-more-tab-<?php echo $_i?>" class="nav-item">
					<a class="nav-link<?php if($front_split[0] == $_k):?> active<?php endif?>" href="<?php echo $g['s']?>/?r=<?php echo $r?>&amp;m=<?php echo $m?>&amp;module=<?php echo $module?>&amp;front=<?php echo $_k ?>">
						<?php echo $_v ?>
					</a>
				</li>
				<?php $_i++;endforeach?>
