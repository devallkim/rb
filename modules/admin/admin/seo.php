<div id="seo-setting" class="p-4">
	...
	<ul class="nav nav-pills mb-3" role="tablist">
		<li class="nav-item">
			<a class="nav-link<?php if(!$_SESSION['sh_admin_seo']||$_SESSION['sh_admin_seo']=='robots'):?> active<?php endif?>" href="#robots" role="tab" data-toggle="tab" onclick="sessionSetting('sh_admin_seo','robots','','');">Robots.txt</a>
		</li>
		<li class="nav-item">
			<a class="nav-link<?php if($_SESSION['sh_admin_seo']=='rewrite'):?> active<?php endif?>" href="#rewrite" role="tab" data-toggle="tab" onclick="sessionSetting('sh_admin_seo','rewrite','','');">URL rewrite</a>
		</li>
		<li class="nav-item">
			<a class="nav-link<?php if($_SESSION['sh_admin_seo']=='sitemap'):?> active<?php endif?>" href="#sitemap" role="tab" data-toggle="tab" onclick="sessionSetting('sh_admin_seo','sitemap','','');">Sitemap.xml</a>
		</li>
		<li class="nav-item">
			<a class="nav-link<?php if($_SESSION['sh_admin_seo']=='errorpage'):?> active<?php endif?>" href="#error" role="tab" data-toggle="tab" onclick="sessionSetting('sh_admin_seo','errorpage','','');">Error Page</a>
		</li>
		<li class="nav-item">
			<a class="nav-link<?php if($_SESSION['sh_admin_seo']=='redirect'):?> active<?php endif?>" href="#301" role="tab" data-toggle="tab" onclick="sessionSetting('sh_admin_seo','redirect','','');">Redirect</a>
		</li>
	</ul>
	...
	<?php endif?>
					...
					<div class="rb-submit">
						<?php if(is_file($_SERVER['DOCUMENT_ROOT'].'/robots.txt')):?>
						<a href="<?php echo $g['s']?>/?r=<?php echo $r?>&amp;m=<?php echo $module?>&amp;a=seo&amp;act=robots_delete" onclick="return hrefCheck(this,true,'정말로 삭제하시겠습니까?');" class="btn btn-light">삭제하기</a>
						<?php endif?>
