		...
		<div class="form-group">
			...
			<div class="col-md-9">
				...
				<p id="ssl_guide" class="form-control-static">
					...
					혹시, 보안서버 미설치 상태에서 전체사이트 체크 후 이상이 생겼을 경우에는 킴스큐 공식포털에서 해결방법을 얻을 수 있습니다.<br>
					</small>
				</p>
			</div>
		</div>
			...
			<div class="col-md-9">
				...
				<p class="form-control-static">
					<small class="text-muted">
						...
						보기) <code>/rb/?m=member</code> 일 경우 코드값은 <code>member</code><br>
					</small>
				</p>
			</div>
		</div>
			...
			<div class="col-md-9">
				...
				<p class="form-control-static">
					<small class="text-muted">
						...
						보기) <code>/rb/?c=ssl</code> 일 경우 코드값은 <code>ssl</code><br>
					</small>
				</p>
			</div>
		</div>
			...
			<div class="col-md-9">
				...
				<p class="form-control-static">
					<small class="text-muted">
						...
						보기) <code>/rb/?mod=ssl</code> 일 경우 코드값은 <code>ssl</code><br>
					</small>
				</p>
			</div>
		</div>
