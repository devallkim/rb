...
(function (factory) {
    ...
    var Comments = {
        ...
        cancelEditMod: function(e){
            ...
            $('[data-role="'+type+'-content-wrapper-'+uid+'"]').text(origin_content); // 기존 원래내용으로 복원
        ...
        setEditModBtn: function(data,mod){
            if(mod=='active'){
                // 입력창 active
                $('[data-role="'+data.type+'-content-wrapper-'+data.uid+'"]')
                .prop("contenteditable",true)
                .css({"border":"solid 1px #ccc","padding":"3px","margin-bottom":"3px","background":"#fff"});
                ...
                .css({"border":"none","padding":"0px","margin-bottom":"0px","background":"none"});
        ...
        showHideOnelineInput: function(e){
            ...
            console.log(oneline_input_wrapper);
        },
        ...
        initWritePerm : function(){
            ...
            if(!this.perm_write){
                ...
                // 댓글 입력창
                $(role_commentInput).css("padding-top","10px");
        ...
        doUserAct : function(e){
            ...
            if(act=='regis' || act=='edit'){
                ...
                else if(act=='edit') content = $('[data-role="'+type+'-content-wrapper-'+uid+'"]').text();
                if(content==''){
                ...
                var msg_container;
                if(type=='comment') msg_container = comment_container;
                ...
                $.post(rooturl+'/?r='+raccount+'&m='+this.module+'&a=do_userAct',{
                    ...
                    if(error){
                        ...
                        if(act=='like'){
                            ...
                            // 해당 row 삭제
                            if(type=='oneline') $(oneline_container).find('[data-uid="'+uid+'"]').remove();
                            else if(type=='comment') $(comment_container).find('[data-uid="'+uid+'"]').remove();
        ...
        updateEdit: function(d){
            ...
            $(content_wrapper).text(d.content);
...
// End of upload setting ********************************************************************************************************
        ...
        getLoader : function(){
            ...
            var loader =$('<div/>',{id: 'kiere-spinner-wrap',html: spinner});
            return loader;
        },

        // loader 출력
        showLoader: function(container,position){
            if(position=='bottom') $(this.loader).attr("class","kiere-bottom5p");
            else if(position=='top') $(this.loader).attr("class","kiere-top5p");
