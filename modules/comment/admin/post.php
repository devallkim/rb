	 	 ...
	 	 <div class="form-group">
	 	 	  ...
	 	 	  <div class="col-sm-10">
                      ...
                      <select name="bid" class="form-control input-sm" onchange="this.form.submit();">
									...
									<option value="">등록된 채팅방이 없습니다.</option>
									<?php endif?>
								</select>
	 	 	  	  	   </div>
	 	 	  	  	   <div class="col-sm-3">
									 <select name="category" onchange="this.form.submit();" class="form-control input-sm">
...
<form name="listForm" action="<?php echo $g['s']?>/" method="post">
		...
		<table class="table table-striped">          
	     ...
	     <tbody>
			...
			<tr>
				...
				<?php if($R['id']):?>
				<td><a href="javascript:OpenWindow('<?php echo $g['s']?>/?r=<?php echo $r?>&iframe=Y&m=member&front=manager&page=post&mbruid=<?php echo $R['mbruid']?>');" title="채팅정보"><?php echo $R[$_HS['nametype']]?></a></td>
				<?php else:?>
    ...
    <?php if(!$NUM):?>
    	<div class="rb-none">채팅물이 없습니다.</div>
	<?php endif?>
