...
$totalPage = $comment->getTotalData($comment->parent,$comment->recnum,'comment','page');
$totalRow = $comment->getTotalData($comment->parent,$comment->recnum,'comment','row');
...
$TMPL['comment_rows'] = $comment->getCommentLog($comment->parent,$sort,$orderby,$recnum,1); // 열람 권한 체크 및 comment 출력
